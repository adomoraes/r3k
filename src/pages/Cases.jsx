							...
							<div className='flex flex-col lg:grid lg:grid-cols-4 lg:grid-rows-2 mt-10'>
									...
									<div className='bg-rose-600 text-white p-4 flex-1 flex flex-col sm:flex-row items-top space-y-4 sm:space-y-0 sm:space-x-4'>
										...
										<p className='text-blue-950 sm:w-full'>
											<strong>
												...
												desenvolvemos uma série especial para o lançamento da
												campanha "Bye bye, bronquiolite",
											</strong>{" "}
											que contou com o apoio da ONG Prematuridade e da Sociedade
											Brasileira de Pediatria. Além dos episódios gravados ao
											vivo, o projeto conta com mais 3 episódios que abordam de
											forma didática o que é a doença e medidas de prevenção
								...
								<div className='bg-blue-950 text-white p-4 flex-1 lg:col-span-1 lg:w-full'>
									...
									<p>
										...
										compartilhou suas experiências sobre a realidade dos
										pacientes e destacou a importância do trabalho de sua
										instituição, que busca garantir soluções para quem conviver
